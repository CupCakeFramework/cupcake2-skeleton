        ...
        <div id="body">
            ...
            <div id="conteudo">
                ...
                <div class="conteudo_right">
                    ...
                    $query = "select * from $sys_tabela where ativo != '' " . $where;
                    //echo $query;
                    ...
                    if ($a == 'e') {
                    echo cria_campo($array_comments[$i], $array_fields[$i], $array_types[$i], $extra, $dados[$i], '');
                    } else {
                    ...
                    echo "
                    <div class=\"item_cad cat_" . $dados_cat['id'] . "\" style=\"clear:both; " . $sty . "\" id=\"linha" . $dados['id'] . "\" >
                    <div class=\"imgsys\">";

                    if ($sys_opc_ativar == '1' && $dados['id'] != '1') {
                    if ($dados['ativo'] == 'Sim') {
