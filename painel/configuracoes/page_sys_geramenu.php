...
if ($_POST) {
    ...
    //Criação do menu
    mysql_query("INSERT INTO `tbl_sys_menu` (
                    `id` ,
                    `nome` ,
                    `pagina` ,
                    `class` ,
                    ...
                    VALUES (
                    NULL , '" . $nome_menu . "', 'page_" . $_POST['nome'] . '.php' . "', 'li_padrao', '1', '0', 'Sim'
                    );");
    ...
    mysql_query(utf8_decode(stripslashes($sql))) or die(mysql_error());
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Painel - Gerador de Pastel</title>
        ...
        <div id="body">
            ...
            <div id="conteudo">
                ...
                <div class="conteudo_right">
                    ...
                    <div class="content_title">Ultra gerador de pastel de flango</div>
                    <div class="content">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <label for="sql">Campos Extras</label>
                            <div id="camposExtras">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            $('.campo_sql').click(function() {
                                ...
                                $('#camposExtras').append("<input type=\"text\" name=\"" + "camposAdicionais[]" + "\" value=\"" + $var + "\" />");
                            })
                        });
